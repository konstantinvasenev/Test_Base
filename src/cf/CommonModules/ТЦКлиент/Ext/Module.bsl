...
Функция ПараметрыОтветаВРМ(СсылкаВРМ) Экспорт
	...
	ПараметрыОтвета.Вставить("ПредставлениеВРМ");
...
Функция ОбработатьСообщениеВРМ(Контекст, Данные) Экспорт
	...
	Попытка
		...
		ИначеЕсли Сообщение = Контекст.Перечисления.ТЦСообщение.Выполнить Тогда
			...
			Если СостояниеАгента = Контекст.Перечисления.ТЦСостояние.Загрузка Тогда
				...
				Если НЕ (Контекст.ИдетПовторноеВыполнение
					...
					УстановитьСостояниеВРМ(Контекст, Контекст.Перечисления.ТЦСостояние.Загрузка);
				...
				ПараметрыОтвета.Состояние = Контекст.Перечисления.ТЦСостояние.Загрузка;
