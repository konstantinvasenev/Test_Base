...
&НаКлиенте
Процедура КритическоеКоличествоОшибокТестаПриИзменении(Элемент)
	ОшибкиПриИзменении();
КонецПроцедуры
...
Процедура ОшибкиПриИзменении()
	...
	Если КритическоеКоличествоОшибокИтерации > КритическоеКоличествоОшибокТеста
		И КритическоеКоличествоОшибокТеста <> 0 Тогда
